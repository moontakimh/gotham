...
export const metadata: Metadata = {
  title: "Handbook — Moontakim",
  description: "Public design system documentation for Gotham.",
};

export default function HandbookPage() {
  return (
    <main className="min-h-full flex-1 bg-canvas pt-[clamp(5rem,12vh,7rem)]">
      <EditorialSection aria-label="Handbook" spacing="chapter">
        <EditorialContainer>
          <EditorialGrid>
            <EditorialCol
              as="p"
            ...
            >
              Philosophy, foundations, tokens, components, accessibility, and editorial
              rhythm — documented publicly as evidence of systems thinking.
            </EditorialCol>
            ...
            >
              v1.0 content follows Figma approval. See{" "}
              <Link href="/colophon" className="underline-offset-4 hover:underline">
                colophon
              </Link>{" "}
              for build notes.
            </EditorialCol>
