...
export function GalleryFull() {
  ...
  return (
    <EditorialSection aria-label="Photography and playlists" spacing="chapter">
      <EditorialContainer>
        <EditorialGrid>
          <EditorialCol
            as="p"
        ...
        <div
          key={mode}
          className="mt-[clamp(3rem,8vh,5rem)] animate-in fade-in duration-300 max-md:ml-[clamp(1.5rem,6vw,3rem)] motion-reduce:animate-none"
        >
          {mode === "photography" ? (
